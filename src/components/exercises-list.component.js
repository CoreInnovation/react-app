          ...
          <td>
            ...
            <tbody>
              ...
              async function aa() {
                ...
                if (window.confirm("Complete code has been copied to the clipboard and you will be taken to HackerRank. Simply paste all code with ctrl-v at the bottom of the HackerRank page and select \"Run Code\" to test.")) {
...
export default class ExercisesList extends Component {
  ...
  componentDidMount() {
    axios.get('http://108.69.56.50:5000/exercises/')
      .then(response => {
  ...
  deleteExercise(id) {
    ...
    {
      axios.delete('http://108.69.56.50:5000/exercises/' + id)
